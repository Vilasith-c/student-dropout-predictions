...
- **Context:** Origin study behind the UCI “Predict Students’ Dropout and Academic Success” dataset (4,424 students, 36 attributes, 3-class target).
...
- **Venue:** Peer-reviewed journal on higher-education analytics (ScienceDirect). 
...
- **Venue:** Open-access article indexed in PubMed Central.
- **Link:** https://pmc.ncbi.nlm.nih.gov/articles/PMC7334184/  
- **Relation:**  
...
- **Venue:** Journal of Education and Computer Applications (open access).
- **Links:**  
  - Article: https://jeca.aks.or.id/jeca/article/view/13  
  - PDF: https://jeca.aks.or.id/jeca/article/download/13/6/61   
- **Relation:**  
...
- **Link:** https://etasr.com/index.php/ETASR/article/view/8644  
- **Relation:**  
...
- **Link:** https://ijisae.org/index.php/IJISAE/article/view/2276 
- **Relation:**  
...
- **Venue:** International Journal of Emerging Technologies in Learning or similar. 
- **Link:** https://www.ijiet.org/vol14/IJIET-V14N8-2133.pdf   
- **Relation:**  
...
- **Venue:** ACM / Springer proceedings. -
- **Link:** https://dl.acm.org/doi/10.1145/3696271.3696288 
- **Relation:**  
...
- **Link:** https://educationaldatamining.org/edm2024/proceedings/2024.EDM-short-papers.32/index.html 
- **Relation:**  
...
- They establish that student dropout prediction is an important and active field where ML is widely used. 
- They justify the selection of Logistic Regression, Random Forest, and XGBoost as core models and provide external performance benchmarks. 
- They show that hyperparameter tuning and more advanced techniques can increase accuracy and F1, which this project explores at a modest level and discusses in relation to complexity. 
